...
/** The link, from anywhere the linked drawings are. */
export function useStepLink(): StepLink {
  const link = useContext(StepLinkContext);
  if (link === null) throw new Error("useStepLink needs a StepLinkProvider above it");
  return link;
}
